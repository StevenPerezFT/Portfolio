            ...
            <section>
                ...
                <section className="my-6 bg-customColor1-200 p-6 border-2 border-customColor3-900 rounded-lg md:ml-10">
                    <div >
                        ...
                        <span className="flex items-center py-1">
                            <p className="flex">Description:</p><p className="text-customColor4-900 pl-1 text-sm md:text-md"> Start up web.</p>
                        </span>
                    </div>
                </section>
            </section>
...
export default CodePocketExperience;
