...
function AboutMe() {
    return (
        <div>
            <h2 className="md:px-5 text-3xl font-bold mb-10  transition-all duration-700 hover:scale-105">About me</h2>
            <section className="my-6 p-6 bg-customColor1-400 rounded-lg max-w-lg ">
                <p className="text-customColor3-900">Hi! My name is Steven and I'm a junior full stack web developer focused on the backend area.
                    <br />
